...
#ifndef __COMBINER_SUB_H__
#define __COMBINER_SUB_H__
...
namespace Unigine {
	...
	/*
	 */
	class CombinerSub : CombinerComplex {
		
		//
		CombinerSub(ObjectMeshSkinned mesh_,Combiner op0_,Combiner op1_) {
			combiner_init(mesh_);
		...
		//
		CombinerSub(ObjectMeshSkinned mesh_) {
			combiner_init(mesh_);
		}
		...
		void setup() {
			...
			mesh.inverseLayer(operands[1].layer,operands[1].layer);
